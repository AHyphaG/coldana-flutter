...
class CategoryModel extends ExpenseCategory {
  ...
  factory CategoryModel.fromJson(Map<String, dynamic> json) {
    return CategoryModel(
      ...
      isDaily:
          json['daily'] == true ||
          json['daily'] == 1, // Changed from 'is_daily' to 'daily'
      dailyBudget:
          json['dailyBudget'] != null
              ? (json['dailyBudget'] as num).toDouble()
              : null,
      activeDays:
          json['activeDays'], // Changed from 'active_days' to 'activeDays'
      isActive:
          json['active'] == true ||
          json['active'] == 1, // Changed from 'isActive' to 'active'
    );
  }
